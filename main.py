...
def Build_model(args):
    ...
    try:
        train_module.build_model(data_path=training_df)
...
def predict_model(args):
    ...
    try:
        args.output=inference_module.make_predictions(predict_df)
...
def main():
    ...
    predict_parser.add_argument("--data", required=True, help="Path to input CSV file")
